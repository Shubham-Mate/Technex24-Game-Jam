...
def paused():
    ...
    largetext = pygame.font.Font('Assets/athletic.ttf', 115)
...
def button(msg, x, y, w, h, ic, ac, action=None):
    ...
    # Render button text
    small_text = pygame.font.Font('Assets/athletic.ttf', 20)
...
def get_font(size):
    return pygame.font.Font("Assets/athletic.ttf", size)

def story():
    global screen, gamestate
    STORY_MOUSE_POS = pygame.mouse.get_pos()

    image = pygame.image.load("assets/images/story.jpg")
    image = pygame.transform.scale(image, screen.get_size())
    screen.blit(image, (0, 0))

    OPTIONS_ENTER = Button(image=None, pos=(screen.get_width() / 2, screen.get_height() - 80), 
                        text_input="PRESS ENTER TO CONTINUE", font=get_font(40), base_color="WHITE", hovering_color="GREEN")
    OPTIONS_ENTER.changeColor(STORY_MOUSE_POS)
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            button_s.play()
            if OPTIONS_ENTER.checkForInput(STORY_MOUSE_POS):
                gamestate = 'menu'
...
def ins1():
    ...
    image = pygame.image.load("assets/images/ins1.jpg")
    image = pygame.transform.scale(image, screen.get_size())
    screen.blit(image, (0, 0))
    

    OPTIONS_BACK = Button(image=None, pos=((100), screen.get_height() - 80), 
                        text_input="BACK", font=get_font(40), base_color="WHITE", hovering_color="GREEN")

    OPTIONS_NEXT = Button(image=None, pos=(screen.get_width() - 100, screen.get_height() - 80), 
...
def ins2():
    ...
    image = pygame.image.load("assets/images/ins2.png")
    image = pygame.transform.scale(image, screen.get_size())
    screen.blit(image, (0, 0))   
    ...
    OPTIONS_PREV = Button(image=None, pos=(100, (screen.get_height()) - 80), 
                        text_input="PREV", font=get_font(40), base_color="WHITE", hovering_color="GREEN")
    
    OPTIONS_PREV.changeColor(OPTIONS_MOUSE_POS)
    OPTIONS_PREV.update(screen)
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if OPTIONS_NEXT.checkForInput(OPTIONS_MOUSE_POS):
                gamestate = 'ins3'
            if OPTIONS_PREV.checkForInput(OPTIONS_MOUSE_POS):
                gamestate = 'ins1'
        if event.type == pygame.KEYDOWN:
            if event.key == pygame.K_ESCAPE:
                gamestate = 'menu'
...
def ins3():
    ...
    image = pygame.image.load("assets/images/ins3.png")
    image = pygame.transform.scale(image, screen.get_size())
    screen.blit(image, (0, 0))    
...
def main_menu():
    ...
    MENU_RECT = MENU_TEXT.get_rect(center=(screen.get_width() / 2, (screen.get_height() / 6) - 10))

    PLAY_BUTTON = Button(image=pygame.image.load("assets/images/Rect.png"), pos=(screen.get_width() / 2, (screen.get_height() / 2) - 150), 
                        text_input="PLAY", font=get_font(65), base_color="#d7fcd4", hovering_color="GREEN")
    INS_BUTTON = Button(image=pygame.image.load("assets/images/Rect.png"), pos=(screen.get_width() / 2, (screen.get_height() / 2)), 
                        text_input="INSTRUCTIONS", font=get_font(65), base_color="#d7fcd4", hovering_color="#ffb311")
    QUIT_BUTTON = Button(image=pygame.image.load("assets/images/Rect.png"), pos=(screen.get_width() / 2, (screen.get_height() / 2) + 150), 
                        text_input="QUIT", font=get_font(65), base_color="#d7fcd4", hovering_color="RED")
    #STORY_BUTTON = Button(image=pygame.image.load("assets/images/Rect.png"), pos=(screen.get_width() / 2, (screen.get_height() / 2) - 60), 
    #                   text_input="STORY", font=get_font(65), base_color="#d7fcd4", hovering_color="White")

    screen.blit(MENU_TEXT, MENU_RECT)

    for button in [PLAY_BUTTON, INS_BUTTON, QUIT_BUTTON]:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if INS_BUTTON.checkForInput(MENU_MOUSE_POS):
                gamestate = 'ins1'
...
def completed():
    ...
    COMPLETED_TEXT = get_font(80).render("Level Completed", True, "#FFBD00")
